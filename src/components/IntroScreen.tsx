...
export function IntroScreen({ handleStart }: IntroScreenProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-bold text-gradient mb-2">كلمه</h1>
        <div className="h-1 w-16 bg-gradient-to-r from-indigo-600 to-teal-500 dark:from-cyan-400 dark:to-teal-400 rounded-full"></div>
      </motion.div>
      ...
      <div className="w-full max-w-md h-[450px] overflow-hidden relative mb-5">
        <AnimatePresence initial={false} custom={direction}>
          ...
          {currentStep === 0 && (
            ...
            >
              <motion.div 
                className="card w-full h-full px-6 py-8 flex flex-col items-center justify-center"
                variants={itemVariants}
              >
                ...
                >
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-indigo-600/20 to-teal-500/20 dark:from-cyan-400/10 dark:to-teal-400/10 blur-md" />
                  <div className="absolute inset-2 rounded-xl flex items-center justify-center bg-white/90 dark:bg-gray-800/90 text-5xl font-bold text-gradient shadow-lg">
                    كلمه
                  </div>
                </motion.div>
              </motion.div>
          ...
          {currentStep === 1 && (
            ...
            >
              <motion.div 
                className="card w-full h-full px-6 py-8 flex flex-col"
                variants={itemVariants}
              >
          ...
          {currentStep === 2 && (
            ...
            >
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center space-y-7 mb-2">
                  {/* Example 1: Correct */}
                  <motion.div 
                    ...
                    transition={{ delay: 0.3 }}
                  >
                    <p className="text-gray-800 dark:text-gray-200 text-right mb-1 text-sm font-medium">
                      المربع <span className="text-green-500 font-bold">الأخضر</span> يعني أن الحرف موجود في المكان الصحيح
                    </p>
                  ...
                  >
                    <p className="text-gray-800 dark:text-gray-200 text-right mb-1 text-sm font-medium">
                      المربع <span className="text-yellow-500 font-bold">الأصفر</span> يعني أن الحرف موجود لكن في مكان خاطئ
                    </p>
                    <div className="flex justify-center gap-1 w-full">
                  ...
                  >
                    <p className="text-gray-800 dark:text-gray-200 text-right mb-1 text-sm font-medium">
                      المربع <span className="text-gray-500 font-bold">الرمادي</span> يعني أن الحرف غير موجود في الكلمة
                    </p>
                    <div className="flex justify-center gap-1 w-full">
                ...
                >
                  ...
                  >
                    ...
                    <svg className="relative w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14 10V4L20 12L14 20V14H6V10H14Z" fill="url(#paint0_linear)" stroke="url(#paint1_linear)" strokeWidth="2" strokeLinejoin="round"/>
                      <defs>
                        <linearGradient id="paint0_linear" x1="6" y1="4" x2="20" y2="20" gradientUnits="userSpaceOnUse">
                          <stop stopColor="#6366F1" stopOpacity="0.6"/>
                          <stop offset="1" stopColor="#14B8A6" stopOpacity="0.6"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear" x1="6" y1="4" x2="20" y2="20" gradientUnits="userSpaceOnUse">
